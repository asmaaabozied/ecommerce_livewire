                            ...
                            <div class="col-xl-12 col-md-12 col-12">
                                ...
                                <div class="row">
                                    <div class="col-xl-8 col-md-8 col-8">
                                        ...
                                        <h4 class="card-title">@lang('lang.cities') ({{$data['total']}})
                                            <span> </span>
                                        </h4>
                                    </div>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a data-toggle="modal" onclick="RenderActions1('')"
                                       data-backdrop="static" data-keyboard="false"           wire:click="toggleEditModal({{$city->id}})"
                                       title="Click to edit"
